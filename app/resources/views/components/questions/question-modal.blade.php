<div id="question-modal" class="fixed inset-0 flex items-center justify-center hidden"
    style="z-index: 9999; background: rgba(0,0,0,0.7);"
    ...
    <div style="background: #18181B; width: 60%; padding: 30px; border-radius: 15px; position: relative;">
        ...
        <h2 style="color: white; font-size: 24px; margin-bottom: 20px;"> {{ __('Ask a Question') }}
        </h2>
        <form action="{{ route('questions.store') }}" method="POST">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <textarea name="content" rows="6" required placeholder="Describe your problem in detail..."
                    style="width: 100%; padding: 12px; border-radius: 10px; border: 1px solid #3F3F46; background: #27272A; color: white;"></textarea>
            </div>
